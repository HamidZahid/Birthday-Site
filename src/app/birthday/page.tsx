  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 2 }}
        className="fixed top-4 right-4 z-40 text-sm text-gray-600 dark:text-gray-400 bg-white/80 dark:bg-gray-800/80 rounded-lg px-3 py-1 backdrop-blur-sm"
      >
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-primary-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900">
        ...
        >
          ...
          <h1 className="text-7xl md:text-9xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-primary-500 to-purple-600 filter drop-shadow-lg leading-tight">
          ...
          <motion.p
            ...
            className="text-2xl md:text-3xl mb-16 text-gray-700 dark:text-gray-300"
          >
            {isCountdownComplete 
        ...
        >
          <div className="w-6 h-10 border-2 border-gray-400 dark:border-gray-500 rounded-full p-1">
            <div className="w-1.5 h-1.5 bg-gray-400 dark:bg-gray-500 rounded-full animate-bounce mx-auto" />
          </div>
        </motion.div>
      </section>
      ...
      <section className="relative py-32 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary-500 to-purple-600">
              Precious Memories
            </h2>
                ...
                <div className="relative overflow-hidden rounded-2xl shadow-xl aspect-[4/3]">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="absolute bottom-0 left-0 right-0 p-8">
                      <h3 className="text-white text-2xl font-semibold mb-3">{photo.title}</h3>
      ...
      <section className="relative py-32 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: index * 0.2 }}
                className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 transform hover:scale-105 transition-transform duration-300"
              >
                <div className="text-4xl mb-4">{wish.emoji}</div>
                <p className="text-gray-700 dark:text-gray-300 mb-4 italic">
                  "{wish.message}"
                </p>
                <p className="text-primary-500 font-semibold">- {wish.author}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="py-8 text-center text-gray-600 dark:text-gray-400 bg-gradient-to-t from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
        <motion.p
          initial={{ opacity: 0 }}
